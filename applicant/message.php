              ...
              <div class="box-body no-padding">
                ...
                <div class="table-responsive mailbox-messages">
                  <table class="table table-hover table-striped">
                    <tbody>
                      <?php
                      $sql = "SELECT * FROM `tblConvocatoria` c,`tblRegistroPostulacion` j,`tblRetroalimentacion` f  WHERE c.`IDCONVOCATORIA`=j.`IDCONVOCATORIA` AND j.`IDREGISTRO`=f.`IDREGISTRO` AND `SOLICITUDPENDIENTE`=0 AND j.`IDPOSTULANTE`='{$_SESSION['IDPOSTULANTE']}'";
                      $mydb->setQuery($sql);
