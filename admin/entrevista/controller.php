...
switch ($action) {
	...
	function doInsert(){
		...
		if ( $_POST['FNAME'] == "" OR $_POST['LNAME'] == ""
			...
			if ($age < 18){
			message("Edad inválida. La edad debe ser mayor a 18 años.", "error");
			redirect("index.php?view=add");
				...
				if ($maxrow > 0) { 
					# code... 
					message("El DNI del postulante ya esta registrado!", "error");
					redirect("index.php?view=add");
				}else{
					...
					message("Fecha de entrevista agregada exitosamente!", "success");
					redirect("index.php");
