...
<body class="hold-transition skin-blue fixed sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="<?php echo web_root; ?>/admin/" class="logo" id="logo_fondo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><img id="logo" src="/convocatorias/admin/user/photos/Logo.png" height="23px"> </span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><img id="logo" src="/convocatorias/admin/user/photos/Logo.png" height="23px"><b> PLAN MERISS</b></span>
      </a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="<?php echo (currentpage() == 'convocatoria') ? "active" : false; ?>">
            <a href="<?php echo web_root; ?>admin/convocatoria/">
              <i class="fa fa-building"></i> <span>Convocatorias</span>
            </a>
          </li>
          <li class="<?php echo (currentpage() == 'comunicado') ? "active" : false; ?>">
            <a href="<?php echo web_root; ?>admin/comunicado/">
              <i class="fa fa-bullhorn"></i> <span>Comunicados</span>
            </a>
          </li>
          ...
          <li class="<?php echo (currentpage() == 'vacante') ? "active" : false; ?>">
            <a href="<?php echo web_root; ?>admin/vacante/">
              <i class="fa fa-suitcase"></i> <span>Vacantes</span>
            </a>
          </li>
          <li class="<?php echo (currentpage() == 'postulante') ? "active" : false; ?>">
            <a href="<?php echo web_root; ?>admin/postulante/">
              <i class="fa fa-users"></i> <span>Postulantes</span>
              <span class="label label-primary pull-right">
                <?php
                $sql = "SELECT count(*) as 'PENDIENTE' FROM `tblRegistroPostulacion` WHERE `SOLICITUDPENDIENTE`=1";
                $mydb->setQuery($sql);
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2023 <a href="#">Plan MERISS</a>.</strong> Todos los derechos reservados.
    </footer>
