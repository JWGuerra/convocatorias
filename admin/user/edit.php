  ...
  <fieldset>
    ...
    <div class="form-group">
      <div class="col-md-8">
        ...
        <div class="col-md-8">
          ...
          <input class="form-control input-sm" id="U_NAME" name="U_NAME" placeholder="Nombre de Cuenta" type="text" value="<?php echo $singleuser->FULLNAME; ?>">
        </div>
      </div>
    </div>
    ...
    <div class="form-group">
      <div class="col-md-8">
        ...
        <div class="col-md-8">
          <input name="deptid" type="hidden" value="">
          <input class="form-control input-sm" id="U_USERNAME" name="U_USERNAME" placeholder="Correo de Usuario" type="text" value="<?php echo $singleuser->USERNAME; ?>">
        </div>
      </div>
    </div>
