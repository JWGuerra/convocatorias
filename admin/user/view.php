    ...
    <div class="row">
      <div class="col-md-4">
        <a data-target="#myModal" data-toggle="modal" href="" title="Click here to Change Image.">
          <img alt="" style="width:300px; height:300px;>" title="" class="img-circle img-thumbnail isTooltip" src="<?php echo web_root . 'admin/user/' . $singleuser->PICLOCATION; ?>" data-original-title="Usuario">
        </a>
      </div>
      <div class="col-md-6">
