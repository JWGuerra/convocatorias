...
<div class="col-sm-6 content-body" >
	...
	<ul> 
		...
		<li>Teléfono : <?php echo $appl->CONTACTNO;?></li>
		<li>Correo : <?php echo $appl->EMAILADDRESS;?></li>
...
<p><i class="fa fa-paperclip"></i>  Documentos Adjuntos</p>
	<div class="col-sm-12 slider">
		 <h3>Descargar Resumen <a href="<?php echo web_root.'applicant/'.$attachmentfile->FILE_LOCATION; ?>">AQUÍ</a></h3>
	</div> 
