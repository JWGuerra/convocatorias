...
<form class="form-horizontal span6" action="controller.php?action=edit" method="POST">
  ...
  <div class="form-group">
    <div class="col-md-8">
      ...
      <div class="col-md-8">
        <input class="form-control input-sm" id="AUTOINC" name="AUTOINC" placeholder="INC" type="text" value="<?php echo $singleauto->AUTOINC; ?>">
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-md-8">
      <label class="col-md-4 control-label" for="AUTOKEY">End:</label>

      <div class="col-md-8">
        <input class="form-control input-sm" id="AUTOKEY" name="AUTOKEY" placeholder="Key" type="text" value="<?php echo $singleauto->AUTOKEY; ?>">
      </div>
    </div>
  </div>
