...
class Database
{
	...
	public function open_connection()
	{
		...
		if (!$this->conn) {
			echo "Problemas con la conexion de base de datos! Contactese con el administrador!";
			exit();
		} else {

			$db_select = mysqli_select_db($this->conn, database_name);
			if (!$db_select) {
				echo "Problemas en la base de datos seleeccionada! Contactese con el administrador!";
				exit();
			}
		}
	}
